...
public class PrincipalActivity extends AppCompatActivity {
    ...
    public static final String ARQUIVO = "br.edu.utfpr.alexandrefeitosa.room1c.PREFERENCIAIS";
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch(which){
                    ...
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        PessoasDatabase database = PessoasDatabase.getDatabase(PrincipalActivity.this);
                        ...
                        if (quantidadeAlterada > 0){
                            ...
                            UtilsGUI.aviso(PrincipalActivity.this, R.string.erro_ao_tentar_apagar);
                        }
                        break;
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        if (bundle != null){
                            ...
                            long id = bundle.getLong(PessoaActivity.ID);

                            PessoasDatabase database = PessoasDatabase.getDatabase(PrincipalActivity.this);

                            Pessoa pessoaEditada = database.getPessoaDao().queryForId(id);
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        if (bundle != null){
                            ...
                            Pessoa pessoaInserida = database.getPessoaDao().queryForId(id);

                            listaPessoas.add(pessoaInserida);
