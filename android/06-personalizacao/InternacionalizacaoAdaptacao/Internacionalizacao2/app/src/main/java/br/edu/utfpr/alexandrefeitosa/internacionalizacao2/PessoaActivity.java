...
public class PessoaActivity extends AppCompatActivity {
    ...
    public static final String MAO_USADA = "MAO_USADA";
    ...
    private boolean bolsistaOriginal;

    private MaoUsada maoUsadaOriginal;
    ...
    public static void editarPessoa(AppCompatActivity activity, ActivityResultLauncher<Intent> launcher, Pessoa pessoa){
        ...
        intent.putExtra(BOLSISTA,  pessoa.isBolsita());
        intent.putExtra(MAO_USADA, pessoa.getMaoUsada().toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            if (modo == NOVO) {
                ...
                bolsistaOriginal = bundle.getBoolean(BOLSISTA);

                checkBoxBolsista.setChecked(bolsistaOriginal);

                maoUsadaOriginal = MaoUsada.valueOf(bundle.getString(MAO_USADA));
    ...
    public void salvar(){
        ...
        if (radioButtonId == R.id.radioButtonDireita){
            ...
            if (radioButtonId == R.id.radioButtonEsquerda){
                ...
                if (radioButtonId == R.id.radioButtonAmbas){
                    ...
                    Toast.makeText(this,
                                    R.string.a_mao_usada_nao_pode_ser_vazia,
                                    Toast.LENGTH_LONG).show();
                    return;
                }
        ...
        intent.putExtra(BOLSISTA, bolsista);
        intent.putExtra(MAO_USADA, maoUsada.toString());
